...
# 🦁 XXD Panel 085｜دفتر المجسمات اليدوية
...
تبقى `sample-01`–`sample-04` محجوزة لنماذج الإصدار الأصلية القابلة للتحقق. تضم الأعمال الثمانية أعلاه أربعة نماذج أفقية 16:9 بتكوين يسار–يمين وأربعة نماذج رأسية 3:4 بتكوين أعلى–أسفل. ولّد Panel 085 كل عمل بصورة مستقلة وفق موجّهه الأصلي، من دون إعادة استخدام أعمال أي Panel آخر. تستخدم النماذج نصاً إنجليزياً مولّداً بذكاء.

<!-- xxd-human-intro:start -->
## ما الذي يحله هذا الأسلوب؟

يملأ نسخ الصورة كاملاً الصفحة بالمعلومات، بينما يفقد الرندر الثلاثي الخالص دفء المادة. يحتاج المصغّر المقنع إلى أن يكون صغيراً وهادئاً ودقيقاً، وأن تحمل آثار الصناعة جزءاً من السرد.

يختزل **Panel 085** العنصر وعلاقات المواد والقصة إلى خشبة يدوية قابلة للاقتناء تشغل نحو 20%–30% فقط من النصف السفلي. يصنع الطين واللباد والورق المقصوص والخيط والورق المقوى والمواد المطفأة تركيباً واحداً يمكن معرفته، وتبقى البصمات والألياف والحواف والانحناءات والفواصل ظاهرة داخل فراغ واسع.

### مناسب لـ

- ضغط صورة معقدة في خشبة مصغرة قابلة للاقتناء لا تحمل إلا الهوية والبيئة الضرورية؛
- جعل البصمات وألياف اللباد والحواف اليدوية والخيط المنحني وفواصل الورق المقوى لغةً بصرية؛
- صنع فخامة عنصر صغير وفراغ كبير بمواد مطفأة وأرضية فاتحة ولون أو لونين للذاكرة؛
- مخرجات أعلى–أسفل ويسار–يمين وتصميم فقط ونسب متعددة وحزم خلفيات ومعالجة المجلدات.

### بداية سريعة

> استخدم XXD Panel 085 لمعالجة هذه الصورة واقترح أولاً أنسب تكوين وحجم.
...
**البصمة:** مسرح مصغّر يدوي · غلاف مجسّم قابل للاقتناء · طين ولباد · ورق مقصوص وخيط · ملمس مطفأ · فراغ فني
...
|---|---|
| **الناتج** | عمل مصغر يجمع غلاف منشور مستقل وملصق معرض وصورة نموذج يدوي |
| **البصمة الواضحة** | عنصر بالغ الصغر وفراغ واسع وألياف وبصمات وحواف مقصوصة وفواصل وظلال مطفأة ناعمة |
| **احترام المصدر** | يحفظ الهوية وعلاقات المواد ومركز الثقل المكاني والبنية السردية ويضغط المشهد في تركيب هادئ واحد |
...
```text
استخلاص الهوية والوضع وعلاقات المواد والبنية السردية → حذف ما عدا الإشارات المكانية الضرورية → إعادة بناء خشبة واحدة بالطين واللباد والورق والخيط والورق المقوى → إبقاء العنصر عند نحو 20%–30% → حفظ البصمات والألياف والحواف والانحناءات والفواصل → استخدام أرضية قريبة من الأبيض ولون أو لونين للذاكرة → دمج بطاقة مادية صغيرة عند الحاجة
```

## سمات النتيجة النهائية

- يشغل المصغّر مساحة صغيرة فقط من النصف السفلي ويُقرأ كخشبة معروضة مستقلة.
- تظهر آثار الطين وألياف اللباد وسماكة الورق والحواف اليدوية وانحناء الخيط ووصلات الورق بملمس محسوس.
- يُسمح ببعض اللاتناظر وخطأ الصناعة، ولا يُسمح بلمعان CG وانعكاس البلاستيك.
- تجعل الأرضية الفاتحة لوناً أو لونين من الأصل مرساةً للذاكرة.
- يظهر النص كملصق صغير أو بطاقة بارزة أو قصاصة ورق أو ملاحظة أرشيفية خافتة.

توجد القيود الجمالية فقط في [الموجّه الأصلي](references/original-prompt/zh-CN.md). يعالج الـ Skill ومهايئات التشغيل متغيرات التسليم فقط. [Skill](SKILL.md) · [مهايئ التشغيل الإنجليزي](references/xxd-panel-085-prompt.en.md)
...
عند تمرير مجلد صور مباشرةً، تعالجه مهارة الجندي دفعةً واحدة بالجمالية الأصلية نفسها لـ Panel 085. تفحص المهارة صيغ الصور النقطية الشائعة تكرارياً، وتعلن العدد، ثم تحسم النمط والحجم والنص واللغة مرة واحدة. تُولَّد كل صورة باستقلال من دون تسرب المحتوى أو النص بين العناصر، وتبقى الدفعة كلها داخل مجلد مهمة مسطح واحد. يُسجَّل فشل أي عنصر من دون إسقاط الصور اللاحقة بصمت.
...
/xxd-panel-085 photo.jpg --mode top-bottom --size auto --text prompt --locale ar-SA
...
/xxd-panel-085 photo.jpg --mode design-only --size 9:16 --text prompt --locale ar-SA
...
/xxd-panel-085 photo.jpg --mode design-only --size 3:4 --text prompt --locale ar-SA

# استخدام النص الحرفي بلا إعادة صياغة أو ترجمة أو عنوان إضافي
/xxd-panel-085 photo.jpg --mode design-only --size 3:4 --copy "دع الضوء يبقى هنا" --locale ar-SA

# نمطان × ثلاثة أحجام ينتجان ستة تكوينات كاملة مستقلة
/xxd-panel-085 photo.jpg --mode top-bottom,design-only --size 1:1,3:4,9:16 --text prompt --locale ar-SA

# تطبيق Panel 085 على مجلد كامل مع حسم الإعدادات المشتركة مرة واحدة
/xxd-panel-085 "/path/to/photos" --mode design-only --size auto,9:16 --text prompt --locale ar-SA
...
يمكن لمستخدمي Claude Code ربط المجلد نفسه بالمسار: `~/.claude/skills/xxd-panel-085`. أعد تشغيل جلسة الوكيل بعد التثبيت.
...
المواصفات الكاملة: [مسار عمل المهارة](SKILL.md) · [أرشيف الأسلوب الأصلي](references/original-prompt/zh-CN.md) · [مهايئ التشغيل الإنجليزي](references/xxd-panel-085-prompt.en.md) · [مهايئ التشغيل الصيني](references/xxd-panel-085-prompt.zh-CN.md)

<!-- xxd-panel-catalog:start -->
## دليل مشاريع XXD Panel الكامل

يحافظ كل مشروع من مشاريع Panel الـ85 على موجّهه الأصلي ومنطقه الجمالي المستقل. يسرد الجدول المشاريع من 001 إلى 085 دون أرقام مفقودة، مع تمييز المشروع الحالي بخط عريض.
...
| **الجنود** | `xxd-panel-NNN` (حالياً 001–085) | تنفذ كل مهارة مرقمة موجّهها الأصلي وجماليتها الخاصة فقط، وتنجز المهمة الفردية التي يرسلها الجنرال. |
